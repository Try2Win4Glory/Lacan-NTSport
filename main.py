...
client = commands.Bot(command_prefix=commands.when_mentioned_or(*['M.', 'm.', '<@!713352863153258556>', '<@713352863153258556>']), case_insensitive=True, intents=intents)
...
async def on_message(message):
  if message.author.bot == True and (
                ...
                or message.content.startswith('M.')
    ...
    try:
        ...
        if message.author.id == 780980594892341288 and (
            ...
            if (message.content.startswith('m.') or message.content.startswith('M.') or message.content.startswith('<@!713352863153258556>') or message.content.startswith('<@713352863153258556>')):
                ...
                try:
                    ...
                    embed.field('__Command__', f'`m.{("".join(list(message.content)[2:]))}`')
