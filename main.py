...
client = commands.Bot(command_prefix=commands.when_mentioned_or(*['M.', 'N.', '<@!713352863153258556>', '<@713352863153258556>']), case_insensitive=True, intents=intents)
  ...
  if message.author.bot == True and (
    ...
    try:
        ...
        if message.author.id == 780980594892341288 and (
            ...
            if (message.content.startswith('N.') or message.content.startswith('M.') or message.content.startswith('<@!713352863153258556>') or message.content.startswith('<@713352863153258556>')):
