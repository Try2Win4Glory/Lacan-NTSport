    ...
    async def verify(self, ctx, type="link"):
        ...
        if type == 'friend':
            ...
            if dbdata['verified'] == 'false':
                ...
                embed = Embed(':clipboard:  Verify your Identity!',
                              f'In order to verify, your ownership of **{dbdata["NTuser"]}**, go [here](https://lns-verification.herokuapp.com/)! \nAfter that run `n.verify` again.')
            ...
            if dbdata['verified'] == 'in progress':
                ...
                if data is not None:
                    ...
                    embed = Embed(':warning:  Nearly there!', f'Nitro Type user **{dbdata["NTuser"]}** did not friend request me yet. In order to verify your ownership for **{dbdata["NTuser"]}**, click [here](https://www.nitrotype.com/racer/lacanverification) and friend request me. \nAfter that make sure to run `n.verify` again.')
                    return await embed.send(ctx)
